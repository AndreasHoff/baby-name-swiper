  ...
  return (
    <div className="w-full max-w-[430px] pl-0 pr-2 mt-2 mx-auto">
      ...
      <ul className="divide-y divide-gray-200 bg-white rounded-lg shadow overflow-x-auto mb-4">
        {favoriteNames.length === 0 && <li className="py-3 px-2 text-center text-gray-400">No favorites yet.</li>}
        {favoriteNames.map(n => (
      ...
      <ul className="divide-y divide-gray-200 bg-white rounded-lg shadow overflow-x-auto mb-4">
        {yesNames.length === 0 && <li className="py-3 px-2 text-center text-gray-400">No names voted YES yet.</li>}
        {yesNames.map(n => (
      ...
      <ul className="divide-y divide-gray-200 bg-white rounded-lg shadow overflow-x-auto mb-4">
        {restNames.length === 0 && <li className="py-3 px-2 text-center text-gray-400">No other names.</li>}
        {restNames.map(n => (
